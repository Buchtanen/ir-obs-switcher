---
name: "source-command-restart-service"
description: "Migrated source command `restart-service`"
---

# source-command-restart-service

Use this skill when the user asks to run the migrated source command `restart-service`.
