---
name: source-command-hotfix
description: Migrated source command `hotfix`
---

# source-command-hotfix

Use this skill when the user asks to run the migrated source command `hotfix`. Canonical command: `.cursor/commands/hotfix.md`.
