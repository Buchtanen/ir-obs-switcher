...
- **Overlay** — sampling, race context, eventy, BLE parser, sysinfo, config write, overlay WS (`tests/test_sampling.py`, `test_race_context.py`, `test_event_*.py`, `test_bio.py`, `test_system_info.py`, `test_overlay_*.py`)
