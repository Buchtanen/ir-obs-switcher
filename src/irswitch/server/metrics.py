...
class MetricsCollector:
    ...
    def get_iracing_connected_duration_seconds(self) -> tuple[Optional[float], Optional[float]]:
        """
    ...
    def get_obs_connected_duration_seconds(self) -> tuple[Optional[float], Optional[float]]:
        """
        ...
        if current_state is not None:
            try:
                result["current_state"] = {
                    ...
                    "scene": current_state.current_scene if hasattr(current_state, "current_scene") else None,
                    "autoswitch": current_state.autoswitch if hasattr(current_state, "autoswitch") else None,
                }
            except Exception:
                pass
