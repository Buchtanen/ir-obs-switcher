...
OVERLAY_FIELDS: tuple[FieldSpec, ...] = (
    ...
    FieldSpec(
        ...
        True,
        "overlay",
        "Overlay copy language. English is the base catalog; missing translations fall back to it.",
        choices=("en", "cs"),
    ),
    FieldSpec(
        "overlay.v4_assets",
    ...
    FieldSpec(
        ...
        True,
        "commentary",
        "TTS engine: auto (SAPI on Windows, espeak-ng on Linux), sapi, espeak, supertonic, or null.",
        choices=("auto", "sapi", "espeak", "supertonic", "null"),
    ),
    FieldSpec(
        ...
        True,
        "commentary",
        "Optional voice name. SAPI: installed voice description. SuperTonic: M1–M5 / F1–F5 (empty = M1).",
        optional=True,
    ),
    FieldSpec(
        "commentary.tts_rate",
        ...
        True,
        "commentary",
        "SAPI-style rate (-10 slow … 10 fast). SuperTonic maps this to speed (0 → 1.05). Browser preview maps this to SpeechSynthesis.rate.",
        -10.0,
        10.0,
    ),
    FieldSpec(
        ...
        True,
        "commentary",
        "SuperTonic inference steps (5–12). Ignored by SAPI/espeak. Default 6.",
        5.0,
        12.0,
    ),
    FieldSpec(
        ...
        True,
        "commentary",
        "Windows playback device substring (e.g. CABLE Input). Empty = default output. 16ch endpoints are skipped when a stereo match exists. Used by SAPI and SuperTonic.",
        optional=True,
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        True,
        "commentary",
        "Fade-out and fade-in duration in milliseconds when ducking OBS audio (0 = instant). SuperTonic synthesizes during fade-out; playback waits until the ramp is down.",
        0.0,
        3000.0,
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        True,
        "commentary",
        "Ollama nucleus-sampling probability for commentary polish.",
        0.0,
        1.0,
    ),
    FieldSpec(
        ...
        True,
        "commentary",
        "Ollama top-k sampling for commentary polish.",
        1.0,
        100.0,
    ),
    FieldSpec(
        ...
        True,
        "commentary",
        "Ollama generation budget for one short TV call.",
        16.0,
        256.0,
    ),
    FieldSpec(
        ...
        True,
        "commentary",
        "Ollama context window for compact DATA + STYLE polish requests.",
        256.0,
        8192.0,
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        "Prepared filler rollout: legacy, shadow, or active.",
        choices=("legacy", "shadow", "active"),
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Capacity reserved for the current stage.",
        0,
        64,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Capacity reserved for the next stage.",
        0,
        64,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Maximum owned generation tasks.",
        1,
        4,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Minimum variants required before selection.",
        3,
        5,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Maximum variants retained per situation.",
        3,
        5,
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Bounded attempts per material plan.",
        1,
        3,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Prepared utterance duration cap.",
        8.0,
        40.0,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Use public completed streams from the existing YouTube account as style memory.",
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Maximum YouTube history entries.",
        10,
        500,
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Use iRacing history when separately authorized.",
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Allow system-state filler plans.",
    ),
    FieldSpec(
        ...
        True,
        "commentary.prepared_filler",
        "Speak the on-air FATAL line when the prepared buffer is exhausted.",
    ),
    FieldSpec(
        "sampling.default_hz",
        "float",
    ...
    FieldSpec(
        ...
        True,
        "battle.hunted",
        "Minimum closing rate (s/s). Negative allows matching or slightly opening pace.",
        -1.0,
        5.0,
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        True,
        "battle",
        "Default debounce after the last place change before one gain/loss emit.",
        0.3,
        5.0,
    ),
    FieldSpec(
        ...
        True,
        "battle",
        "Longer end-of-swing wait after an incident or a multi-place jump.",
        0.5,
        15.0,
    ),
    FieldSpec(
        ...
        True,
        "battle",
        "Use swing debounce for this long after incident points or off-track.",
        1.0,
        30.0,
    ),
    FieldSpec(
...
def overlay_values(settings: OverlaySettings) -> dict[str, Any]:
    ...
    return {
        ...
        "commentary.tts_steps": s.commentary.tts_steps,
        ...
        "commentary.llm_top_p": s.commentary.llm_top_p,
        "commentary.llm_top_k": s.commentary.llm_top_k,
        "commentary.llm_num_predict": s.commentary.llm_num_predict,
        ...
        "commentary.prepared_filler.mode": s.commentary.prepared_filler.mode,
        "commentary.prepared_filler.max_ready_plans": s.commentary.prepared_filler.max_ready_plans,
        "commentary.prepared_filler.reserved_current_stage": s.commentary.prepared_filler.reserved_current_stage,
        "commentary.prepared_filler.reserved_next_stage": s.commentary.prepared_filler.reserved_next_stage,
        "commentary.prepared_filler.max_inflight": s.commentary.prepared_filler.max_inflight,
        "commentary.prepared_filler.variants_min": s.commentary.prepared_filler.variants_min,
        "commentary.prepared_filler.variants_max": s.commentary.prepared_filler.variants_max,
        "commentary.prepared_filler.generation_timeout_s": s.commentary.prepared_filler.generation_timeout_s,
        "commentary.prepared_filler.generation_max_attempts": s.commentary.prepared_filler.generation_max_attempts,
        "commentary.prepared_filler.max_utterance_s": s.commentary.prepared_filler.max_utterance_s,
        "commentary.prepared_filler.youtube_history": s.commentary.prepared_filler.youtube_history,
        "commentary.prepared_filler.youtube_history_days": s.commentary.prepared_filler.youtube_history_days,
        "commentary.prepared_filler.youtube_history_max_items": s.commentary.prepared_filler.youtube_history_max_items,
        "commentary.prepared_filler.iracing_history": s.commentary.prepared_filler.iracing_history,
        "commentary.prepared_filler.system_filler": s.commentary.prepared_filler.system_filler,
        "commentary.prepared_filler.speak_fatal_notice": s.commentary.prepared_filler.speak_fatal_notice,
        ...
        "battle.position_swing_debounce_s": s.battle.position_swing_debounce_s,
        "battle.position_incident_window_s": s.battle.position_incident_window_s,
        ...
        "events.priorities.leader_change": s.events.priorities.leader_change,
