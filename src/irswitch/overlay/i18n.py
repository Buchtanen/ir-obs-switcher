...
EN: Mapping[str, str] = MappingProxyType(
    {
        ...
        "position.leader_change": "NEW LEADER",
        ...
        "timing.sector_best": "SECTOR BEST",
...
CS: Mapping[str, str] = MappingProxyType(
    {
        ...
        "battle.battle_for_position": "SOUBOJ O POZICI",
        "battle.won": "SOUBOJ VYHRÁN",
        ...
        "position.rival_threat": "HROZBA ZE ZADU",
        "position.leader_change": "NOVÝ LÍDR",
        "session.final_lap": "POSLEDNÍ KOLO",
        "session.finish": "CÍL",
        "incident": "INCIDENT",
        "exception.incident": "INCIDENT",
        "exception.invalid_lap": "NEPLATNÉ KOLO",
        "exception.link_drop": "VÝPADEK SPOJENÍ",
        ...
        "timing.sector_best": "NEJLEPŠÍ SEKTOR",
