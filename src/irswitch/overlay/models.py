...
class TelemetrySnapshot:
    ...
    car_idx_f2_time: tuple[float | None, ...] = ()
    car_idx_pace_line: tuple[int | None, ...] = ()
    car_idx_pace_row: tuple[int | None, ...] = ()
...
class RaceState:
    ...
    official_class_position: int | None = None
    position_source: str = "official"  # live | official | grid
    car_idx_live_position: tuple[int | None, ...] = ()
    car_idx_live_class_position: tuple[int | None, ...] = ()
