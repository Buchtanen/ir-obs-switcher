...
class LoadingTimeTracker:
    ...
    def __init__(self, history_file: Path | str = DEFAULT_HISTORY_FILE, default_loading_time_seconds: float = 12.0) -> None:
        """
        ...
        try:
            with open(self.history_file, "r", encoding="utf-8") as f:
                ...
                if isinstance(data, list):
                    ...
                    logger.info(f"Loaded {len(self.history)} loading time records from {self.history_file}")
                else:
