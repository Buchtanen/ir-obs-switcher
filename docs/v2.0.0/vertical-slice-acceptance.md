...
- Live-path composition safety before Windows gates: [#349](https://github.com/Buchtanen/ir-obs-switcher/issues/349) (Slice 1 kill-switch + Slice 2 mailbox cutover landed; TTS protocol, Qwen fail-closed, HTTP/mediums still open).
