...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 1 open:** offline pytest consumer of frozen F01–F44 machine projection (`tests/test_vertical_slice_fixtures.py`) + gap inventory; live §24.9 / Windows gates deferred.
