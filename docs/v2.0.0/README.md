...
- [ ] [#349 — v2: live-path composition safety before §24.9](https://github.com/Buchtanen/ir-obs-switcher/issues/349) — kill-switch / mailbox / TTS protocol / Qwen fail-closed / HTTP+mediums after Sol tip audit FAIL @ `03205d6`. **Slice 3 in flight:** real TTS accept/terminal + backend identity (`tests/test_live_path_tts_protocol.py`); Slices 1–2 on tip.
