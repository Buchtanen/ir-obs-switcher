...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 5 open:** Slice 1–4 + F01/F10/F17 offline stream/silence drivers (`tests/test_vertical_slice_silence_runtime.py`); **18/44** wired; live §24.9 / Windows gates deferred.
