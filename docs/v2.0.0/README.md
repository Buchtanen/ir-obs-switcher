...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 17 open:** Slice 1–16 + F30 offline TTS auto-resolution drivers (`tests/test_vertical_slice_tts_auto_runtime.py`); **38/44** wired; live §24.9 / Windows gates deferred.
