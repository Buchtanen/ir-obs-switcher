...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. Offline **44/44** wired; live §24.9 Windows smoke checklist: [`stream-test-checklist-24.9.md`](./stream-test-checklist-24.9.md) (composition safety cleared via #349 @ `a063143`).
- [ ] [#349 — v2: live-path composition safety before §24.9](https://github.com/Buchtanen/ir-obs-switcher/issues/349) — **slices 1–5 on tip** @ `a063143` (kill-switch / mailbox / TTS protocol / Qwen fail-closed / HTTP+mediums). Stream smoke may start; keep open until #278 records §24.9 smoke/GO.
