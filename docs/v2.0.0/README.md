...
- [ ] [#349 — v2: live-path composition safety before §24.9](https://github.com/Buchtanen/ir-obs-switcher/issues/349) — kill-switch / mailbox / TTS protocol / Qwen fail-closed / HTTP+mediums after Sol tip audit FAIL @ `03205d6`. **Slice 1 in flight:** `commentary.enabled` gates shadow+Qwen hard-enables (`tests/test_live_path_kill_switch.py`).
