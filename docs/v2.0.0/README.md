...
- [ ] [#274 — v2: migrate race outcome event families](https://github.com/Buchtanen/ir-obs-switcher/issues/274) — position/pass/overtake/leader/finish. **Slice 4 in progress:** verifier minimal pairs via `contracts/race_outcome_verifier_pairs.py`; see [race-outcome-migration.md](race-outcome-migration.md).
