...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 4 open:** Slice 1–3 harness/expiry/transition + F05/F06/F07 offline director scoring (`tests/test_vertical_slice_scoring_runtime.py`); **15/44** wired; live §24.9 / Windows gates deferred.
