...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 10 open:** Slice 1–9 + F12/F29 offline manual-disabled + lexicon drivers (`tests/test_vertical_slice_manual_lexicon_runtime.py`); **28/44** wired; live §24.9 / Windows gates deferred.
