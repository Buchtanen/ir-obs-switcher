...
- [ ] [#275 — v2: migrate lap, sector, practice and qualifying families](https://github.com/Buchtanen/ir-obs-switcher/issues/275) — timing and inherited recaps. **Slice 3 open:** lap/SF + sector + PB/pace + hot/projected/invalid inventory — [timing-family-migration.md](timing-family-migration.md).
