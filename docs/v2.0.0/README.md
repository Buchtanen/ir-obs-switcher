...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 21 open:** Slice 1–20 + F40 offline Qwen authority drivers (`tests/test_vertical_slice_qwen_authority_runtime.py`); **42/44** wired; live §24.9 / Windows gates deferred.
