...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 2 open:** Slice 1 harness + F08/F15/F24 offline expiry runtime drivers (`tests/test_vertical_slice_expiry_runtime.py`); **9/44** wired; live §24.9 / Windows gates deferred.
