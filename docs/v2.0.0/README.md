...
- [ ] [#275 — v2: migrate lap, sector, practice and qualifying families](https://github.com/Buchtanen/ir-obs-switcher/issues/275) — timing and inherited recaps. **Slice 5 open:** EN patterns + TTS slot formats curated — [timing-family-migration.md](timing-family-migration.md).
