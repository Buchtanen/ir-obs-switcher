...
- [ ] [#276 — v2: migrate pit, incident, flag and recovery families](https://github.com/Buchtanen/ir-obs-switcher/issues/276) — stateful operational stories. **Slice 4 open:** pit + incident + `SESSION_FLAG` + checkered / hero finish / session wrap inventory — [ops-family-migration.md](ops-family-migration.md).
