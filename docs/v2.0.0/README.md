...
- [x] [#276 — v2: migrate pit, incident, flag and recovery families](https://github.com/Buchtanen/ir-obs-switcher/issues/276) — stateful operational stories. **Slice 7 shadow open:** Slices 1–5 inventory + EN patterns / TTS slots + adversarial tests (still `legacy`) — observational shadow on tip; no live v2 speech — [ops-family-migration.md](ops-family-migration.md).
