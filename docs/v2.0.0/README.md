...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 16 open:** Slice 1–15 + F26 offline unresponsive-TTS lane-watchdog drivers (`tests/test_vertical_slice_tts_timeout_runtime.py`); **37/44** wired; live §24.9 / Windows gates deferred.
