...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 3 open:** Slice 1–2 harness + F02/F03/F04 offline transition drivers (`tests/test_vertical_slice_transition_runtime.py`); **12/44** wired; live §24.9 / Windows gates deferred.
