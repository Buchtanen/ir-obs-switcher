...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 14 open:** Slice 1–13 + F28 offline feature-order + bucket-coverage drivers (`tests/test_vertical_slice_feature_order_runtime.py`); **35/44** wired; live §24.9 / Windows gates deferred.
