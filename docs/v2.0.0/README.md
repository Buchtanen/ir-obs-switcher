...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 6 open:** Slice 1–5 + F23/F37 offline director policy drivers (`tests/test_vertical_slice_policy_runtime.py`); **20/44** wired; live §24.9 / Windows gates deferred.
