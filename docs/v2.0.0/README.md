...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 20 open:** Slice 1–19 + F43 offline tape-channel funnel drivers (`tests/test_vertical_slice_tape_funnel_runtime.py`); **41/44** wired; live §24.9 / Windows gates deferred.
