...
**Status:** Wave C #247–#256 and Wave D #257–#262 plus #263 and #283 closed on this branch; #264 closed; #265 closed; #266 closed; #267 closed; #268 closed; #269 closed; #271 closed. [#284](https://github.com/Buchtanen/ir-obs-switcher/issues/284) **OPEN** — library StoryDirector composition + shadow NarrativeIngress + **enabled** shadow fanout cutover (live batch adapter) + commentary-runtime HTTP status mount slice landed on branch `cursor/narrative-runtime-284-matrix-cad3` (`events/narrative_runtime.py` **124** + `events/narrative_ingress.py` **5** + `events/narrative_shadow_consumer.py` **6** + `events/narrative_runtime_http.py` **5** + `tests/test_narrative_fanout_cutover.py` **5** + `tests/test_narrative_shadow_adapter.py` **4** = **149** related tests: matrix + effect executor + silence/validity/realization/speech deadline timers + optional FreshnessGate/OpportunityQueue/EpisodeRegistry/StoryDirector composition + shadow fanout→adapter→ingress→`reduce_next()` cutover + process-level HTTP attach + `project_runtime_status` subset + `GET /api/commentary/runtime` (process attach when shadow enabled) + enabled race shadow consumer (`_narrative_shadow_enabled=True`); enabled shadow cutover feat SHA `16c0e66`; prior reduce+status attach feat `975d3e1`; prior NarrativeRuntime HTTP feat `f4d1725`; prior NarrativeShadowConsumer feat `eaa58c9`; prior NarrativeIngress feat `13b744a`; prior StoryDirector feat `5fb8041`; prior EpisodeRegistry slice `5d59554`; prior OpportunityQueue slice `b306deb`; prior FreshnessGate slice `08472ed`); live CommentaryConsumer EventSubscription cutover and `NarrativeRuntime.run()` deferred. Not shipped on `master`.
...
**Catalog behavior:** [Implementation-time 60/64 matrix, DAG and replay refs](catalog-behavior.md) — auditor `src/irswitch/contracts/coverage_matrix.py`, loader `src/irswitch/contracts/catalog_loader.py`, registry `src/irswitch/events/episode_registry.py`, retention `src/irswitch/events/episode_retention.py`, silence `src/irswitch/events/silence_clock.py`, planner `src/irswitch/events/beat_plan.py`, exposure `src/irswitch/events/exposure_store.py`, opportunity queue `src/irswitch/events/opportunity_queue.py`, director `src/irswitch/events/story_director.py`, speech lane `src/irswitch/events/speech_lane.py`, freshness `src/irswitch/events/freshness_commit.py`, realization catalog `src/irswitch/contracts/realization_catalog.py`, authored pack `src/irswitch/contracts/authored_pack.py`, prompt compiler `src/irswitch/events/prompt_compiler.py`, Qwen transport `src/irswitch/events/qwen_transport.py`, SemanticVerifier `src/irswitch/events/semantic_verifier.py`, eval corpus `src/irswitch/events/eval_corpus.py`, NarrativeRuntime reducer `src/irswitch/events/narrative_runtime.py`, shadow NarrativeIngress `src/irswitch/events/narrative_ingress.py`, enabled NarrativeShadowConsumer `src/irswitch/events/narrative_shadow_consumer.py`, live batch adapter `src/irswitch/events/narrative_shadow_adapter.py`, HTTP status mount `src/irswitch/events/narrative_runtime_http.py`; module lookup [inflight § #284 runtime](../dokumentace/inflight/README.md#284-narrative-runtime-lookup) · [inflight § #284 ingress shadow](../dokumentace/inflight/README.md#284-narrative-ingress-shadow-lookup) · [inflight § #284 shadow consumer](../dokumentace/inflight/README.md#284-narrative-shadow-consumer-lookup) · [inflight § #284 shadow adapter](../dokumentace/inflight/README.md#284-narrative-shadow-adapter-lookup) · [inflight § #284 HTTP mount](../dokumentace/inflight/README.md#284-narrative-runtime-http-lookup) · [inflight § #284 fanout cutover](../dokumentace/inflight/README.md#284-shadow-fanout-cutover-lookup) (#271: [eval corpus](../dokumentace/inflight/README.md#271-eval-corpus-lookup); #268: [prompt compiler](../dokumentace/inflight/README.md#268-prompt-compiler-lookup); #267: [authored pack](../dokumentace/inflight/README.md#267-authored-pack-lookup); #266: [RealizationCatalog](../dokumentace/inflight/README.md#266-realization-catalog-lookup); #265: [FreshnessGate](../dokumentace/inflight/README.md#265-freshness-commit-lookup); #283: [EventOpportunity queue](../dokumentace/inflight/README.md#283-expiring-event-opportunities-lookup); #263: [ExposureStore](../dokumentace/inflight/README.md#263-exposure-store-lookup); #261: [BeatPlan](../dokumentace/inflight/README.md#261-immutable-beatplan-lookup); #260: [SilenceClock](../dokumentace/inflight/README.md#260-long-silence-lifecycle-lookup); #259: [EpisodeRetention](../dokumentace/inflight/README.md#259-resolved-episode-retention-lookup); #258: [EpisodeRegistry](../dokumentace/inflight/README.md#258-lineage-aware-episoderegistry-lookup); #257: [catalog loader](../dokumentace/inflight/README.md#257-storydefinition-catalog-loader-lookup); #256: [coverage matrix](../dokumentace/inflight/README.md#256-event-family-coverage-matrix-lookup))
...
- [x] [#235 — v2: architecture contracts and dependency-direction ADR](https://github.com/Buchtanen/ir-obs-switcher/issues/235) — mandatory design-freeze gate; no runtime behavior edit may precede closure.
- [x] [#236 — v2: versioned IDs, clocks, units and schema primitives](https://github.com/Buchtanen/ir-obs-switcher/issues/236) — depends on #235.
...
- [x] [#240 — v2: bounded asynchronous NarrativeTape writer](https://github.com/Buchtanen/ir-obs-switcher/issues/240) — depends on #239.
- [x] [#241 — v2: trigger-driven CapturePlan compiler](https://github.com/Buchtanen/ir-obs-switcher/issues/241) — depends on #238–#240.
- [x] [#242 — v2: replay reader, label sidecars and evaluation reports](https://github.com/Buchtanen/ir-obs-switcher/issues/242) — depends on #239, #240.
...
- [x] [#245 — v2: typed AtomicFact ledger and provenance](https://github.com/Buchtanen/ir-obs-switcher/issues/245) — depends on #236, #244.
- [x] [#246 — v2: fact inheritance, supersession and summaries](https://github.com/Buchtanen/ir-obs-switcher/issues/246) — depends on #245.
...
- [x] [#256 — v2: v2 event-family coverage matrix](https://github.com/Buchtanen/ir-obs-switcher/issues/256) — depends on #235, #236; audits all 60 identifiers and the 64-beat baseline.

## Wave D — episodes, beats and direction

- [x] [#257 — v2: StoryDefinition schema and catalog loader](https://github.com/Buchtanen/ir-obs-switcher/issues/257) — depends on #249, #256.
- [x] [#258 — v2: lineage-aware EpisodeRegistry](https://github.com/Buchtanen/ir-obs-switcher/issues/258) — depends on #244, #245, #257.
...
- [x] [#262 — v2: StoryDirector eligibility and deterministic arbitration](https://github.com/Buchtanen/ir-obs-switcher/issues/262) — depends on #261, #283.
...
- [x] [#267 — v2: authored critical and lifecycle realization pack](https://github.com/Buchtanen/ir-obs-switcher/issues/267) — depends on #261, #266.
- [x] [#268 — v2: dynamic compiled PromptOptions and prompt profiles](https://github.com/Buchtanen/ir-obs-switcher/issues/268) — depends on #261, #266.
- [x] [#269 — v2: bounded Qwen transport and warm-up](https://github.com/Buchtanen/ir-obs-switcher/issues/269) — depends on #238, #264, #268.
- [x] [#270 — v2: family-specific SemanticVerifier](https://github.com/Buchtanen/ir-obs-switcher/issues/270) — depends on #261, #266, #268.
- [x] [#271 — v2: LLM evaluation corpus and latency report](https://github.com/Buchtanen/ir-obs-switcher/issues/271) — depends on #239, #242, #269, #270.
...
- [x] [#275 — v2: migrate lap, sector, practice and qualifying families](https://github.com/Buchtanen/ir-obs-switcher/issues/275) — timing and inherited recaps. **CLOSED** — observational shadow on tip; no live v2 speech — [timing-family-migration.md](timing-family-migration.md).
- [x] [#276 — v2: migrate pit, incident, flag and recovery families](https://github.com/Buchtanen/ir-obs-switcher/issues/276) — stateful operational stories. **CLOSED** Slices 1–5 inventory + EN patterns / TTS slots + adversarial tests observational shadow on tip @ closeout; no live v2 speech — [ops-family-migration.md](ops-family-migration.md).
- [x] [#277 — v2: migrate session, filler, weather, field and bio families](https://github.com/Buchtanen/ir-obs-switcher/issues/277) — non-race-event commentary. **CLOSED** — Slice 7 inventory shadow on tip: session leftovers + filler + weather/field + bio style + long-silence + EN + inventory shadow (`STREAM_START`, `SESSION_PREVIEW`, `ENTER_CAR`, `FINAL_LAP`, `PARADE_PAD`, `WEATHER_BRIEF`, `WEATHER_CHANGE`, `FIELD_FACT`, `SOF_BRIEF`, `HR_PRESSURE_RISING` + impulse `LONG_SILENCE_ELAPSED`, all inventory `shadow`; **no** `FAMILY_ROUTE` flip) — [context-family-migration.md](context-family-migration.md).
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 23 open:** Slice 1–22 + F19 offline recovery-barrier drivers (`tests/test_vertical_slice_recovery_barrier_runtime.py`); **44/44** wired; live §24.9 / Windows gates deferred until [#349](https://github.com/Buchtanen/ir-obs-switcher/issues/349) composition safety.
- [ ] [#349 — v2: live-path composition safety before §24.9](https://github.com/Buchtanen/ir-obs-switcher/issues/349) — kill-switch / mailbox / TTS protocol / Qwen fail-closed / HTTP+mediums after Sol tip audit FAIL @ `03205d6`. **Slice 2 in flight:** mailbox `ConfigUpdate`/`SessionReset` admit + stream-following shadow revisions (`tests/test_live_path_mailbox_cutover.py`); Slice 1 kill-switch on tip.
