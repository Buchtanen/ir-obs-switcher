...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 15 open:** Slice 1–14 + F16 offline disable/re-enable-within-broadcast drivers (`tests/test_vertical_slice_disable_reenable_runtime.py`); **36/44** wired; live §24.9 / Windows gates deferred.
