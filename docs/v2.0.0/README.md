...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 19 open:** Slice 1–18 + F41 offline TTS software-boundary drivers (`tests/test_vertical_slice_tts_boundaries_runtime.py`); **40/44** wired; live §24.9 / Windows gates deferred.
