...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 9 open:** Slice 1–8 + F13/F20 offline mailbox/manual drivers (`tests/test_vertical_slice_mailbox_manual_runtime.py`); **26/44** wired; live §24.9 / Windows gates deferred.
