...
- [ ] [#349 — v2: live-path composition safety before §24.9](https://github.com/Buchtanen/ir-obs-switcher/issues/349) — kill-switch / mailbox / TTS protocol / Qwen fail-closed / HTTP+mediums after Sol tip audit FAIL @ `03205d6`. **Slice 5 in flight:** HTTP/mediums (`tests/test_live_path_http_mediums.py`); Slices 1–4 on tip.
