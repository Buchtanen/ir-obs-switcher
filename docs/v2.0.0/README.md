...
**Status:** Wave C #247–#256 implemented on this branch; next is #257. #256 coverage-matrix auditor is on the branch, not shipped.
...
**Catalog behavior:** [Implementation-time 60/64 matrix, DAG and replay refs](catalog-behavior.md) — auditor `src/irswitch/contracts/coverage_matrix.py`; module lookup [inflight § #256](../dokumentace/inflight/README.md#256-event-family-coverage-matrix-lookup)
