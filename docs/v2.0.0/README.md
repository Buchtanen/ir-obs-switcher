...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 13 open:** Slice 1–12 + F14/F35 offline playback-race + planning-replace drivers (`tests/test_vertical_slice_playback_replace_runtime.py`); **34/44** wired; live §24.9 / Windows gates deferred.
