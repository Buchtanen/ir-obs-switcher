...
- [ ] [#284 — v2: single-owner NarrativeRuntime actor and command lifecycle](https://github.com/Buchtanen/ir-obs-switcher/issues/284) — owns mailbox ordering, effects, recovery and shutdown; depends on #237, #238, #240, #243, #245, #258, #262, #264, #265 and #269. **Branch library slice (OPEN):** reducer matrix + owned realization/TTS effect tasks + silence/validity/realization/speech deadline timers + optional FreshnessGate/OpportunityQueue/EpisodeRegistry/StoryDirector composition + shadow `NarrativeIngress` fanout→mailbox adapter + **enabled** fanout→`adapt_batch_for_shadow`→`reduce_next()` cutover + process-level HTTP attach + `project_runtime_status` subset + `GET /api/commentary/runtime` HTTP mount + enabled `NarrativeShadowConsumer` in `race.runtime` (feat `16c0e66`, **149** related tests) — [inflight § #284 runtime](../dokumentace/inflight/README.md#284-narrative-runtime-lookup) · [inflight § #284 ingress shadow](../dokumentace/inflight/README.md#284-narrative-ingress-shadow-lookup) · [inflight § #284 shadow consumer](../dokumentace/inflight/README.md#284-narrative-shadow-consumer-lookup) · [inflight § #284 shadow adapter](../dokumentace/inflight/README.md#284-narrative-shadow-adapter-lookup) · [inflight § #284 HTTP mount](../dokumentace/inflight/README.md#284-narrative-runtime-http-lookup) · [inflight § #284 fanout cutover](../dokumentace/inflight/README.md#284-shadow-fanout-cutover-lookup); live CommentaryConsumer EventSubscription cutover and `NarrativeRuntime.run()` not done.
