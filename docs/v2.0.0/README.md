...
- [ ] [#272 — v2: legacy-to-v2 adapter and shadow comparison](https://github.com/Buchtanen/ir-obs-switcher/issues/272) — **in progress** (partial AC **2/4**); first slice feat `f72eb8c` on `cursor/legacy-v2-shadow-272-cad3` — silent lap-family director shadow compare (`events/legacy_v2_shadow_compare.py`, **5** tests); temporary branch-only harness after #284, removed before final PR. [inflight § #272](../dokumentace/inflight/README.md#272-lap-family-legacyv2-director-shadow-compare-slice-2026-09-11).
