...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 7 open:** Slice 1–6 + F21/F42 offline partition/silence-origin drivers (`tests/test_vertical_slice_partition_silence_runtime.py`); **22/44** wired; live §24.9 / Windows gates deferred.
