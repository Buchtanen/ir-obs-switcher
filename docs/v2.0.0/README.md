...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 22 open:** Slice 1–21 + F36 offline mixed-boundary config drivers (`tests/test_vertical_slice_config_boundary_runtime.py`); **43/44** wired; live §24.9 / Windows gates deferred.
