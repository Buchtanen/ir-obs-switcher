...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 18 open:** Slice 1–17 + F39 offline TTS request/callback protocol drivers (`tests/test_vertical_slice_tts_protocol_runtime.py`); **39/44** wired; live §24.9 / Windows gates deferred.
