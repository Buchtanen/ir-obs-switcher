...
- [ ] [#276 — v2: migrate pit, incident, flag and recovery families](https://github.com/Buchtanen/ir-obs-switcher/issues/276) — stateful operational stories. **Slice 6 open:** Slices 1–5 inventory + EN patterns / TTS slots + adversarial tests (still `legacy`) — [ops-family-migration.md](ops-family-migration.md).
