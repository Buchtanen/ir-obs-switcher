...
**Machine freeze artifacts:** [Generated registries, DTO/beat/graph/config/API schemas, goldens, mutation fixtures, checkers and V4 wire golden](machine/README.md)
