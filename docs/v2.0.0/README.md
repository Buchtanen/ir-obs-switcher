...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 12 open:** Slice 1–11 + F18/F33 offline context-cut + prompt-freedom drivers (`tests/test_vertical_slice_context_prompt_runtime.py`); **32/44** wired; live §24.9 / Windows gates deferred.
