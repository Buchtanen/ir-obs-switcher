...
- [ ] [#278 — v2: production vertical-slice end-to-end acceptance](https://github.com/Buchtanen/ir-obs-switcher/issues/278) — internal live checkpoint, not a partial release; includes #283 evidence. **Slice 8 open:** Slice 1–7 + F09/F11 offline Qwen hard-fail drivers (`tests/test_vertical_slice_qwen_runtime.py`); **24/44** wired; live §24.9 / Windows gates deferred.
