...
- [ ] [#275 — v2: migrate lap, sector, practice and qualifying families](https://github.com/Buchtanen/ir-obs-switcher/issues/275) — timing and inherited recaps. **Slice 4 open:** timing + practice→qualifying→race session intros/recaps — [timing-family-migration.md](timing-family-migration.md).
