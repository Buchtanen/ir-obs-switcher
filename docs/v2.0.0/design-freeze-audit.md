...
- DTO fields, schema versions, stream-scope nullability, canonical hashes, tape envelopes and reason IDs live in `schema-contracts.md`; 25 closed DTO definitions, positive/negative structural goldens and the unchanged V4 wire golden are materialized in `machine/`.
