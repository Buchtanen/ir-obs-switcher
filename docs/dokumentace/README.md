...
| #278 vertical-slice acceptance (Slice 1 harness + Slice 2 F08/F15/F24 expiry runtime) | [vertical-slice-acceptance.md § Slice 2](../v2.0.0/vertical-slice-acceptance.md#slice-2--f08f15f24-expiry-runtime-drivers), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), [`tests/test_vertical_slice_expiry_runtime.py`](../../tests/test_vertical_slice_expiry_runtime.py), [inflight § #278 slice 1](inflight/README.md#278-vertical-slice-fixtures-slice-1-lookup), [inflight § #278 slice 2](inflight/README.md#278-vertical-slice-expiry-runtime-slice-2-lookup), [testy-ci § #278 slice 1](domeny/testy-ci.md#278-vertical-slice-fixture-pytest-harness-slice-1), [testy-ci § #278 slice 2](domeny/testy-ci.md#278-vertical-slice-expiry-runtime-slice-2) | live Windows §24.9 GO; `machine/*` hash rewrite; **`CONFIG.md` / `API.md` unchanged** |
