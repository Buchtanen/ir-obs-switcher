...
| Wave G #274 race-outcome family map (slice 1, open PR) | [race-outcome-migration.md](../v2.0.0/race-outcome-migration.md), [inflight § #274](inflight/README.md#274-race-outcome-family-map-slice-1-lookup), [events branch delta](domeny/events.md#race-outcome-migration-map-contractsrace_outcome_family_mappy) | `domeny/events.md` jako shipped map truth; `mapa-souboru.md` (absent on branch) |
