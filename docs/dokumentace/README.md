...
| Wave G #275 timing family map (CLOSED)
| Wave G #276 ops family map (slice 1, open) | [ops-family-migration.md](../v2.0.0/ops-family-migration.md), [inflight § #276](inflight/README.md#276-ops-family-map-slice-1-lookup), [events branch delta](domeny/events.md#ops-family-migration-map-contractsops_family_mappy) | `domeny/events.md` as shipped map truth; live `FAMILY_ROUTE` flip | | [timing-family-migration.md](../v2.0.0/timing-family-migration.md), [inflight § #275](inflight/README.md#275-timing-family-map-slice-8-lookup), [events branch delta](domeny/events.md#timing-family-migration-map-contractstiming_family_mappy) | `domeny/events.md` as shipped map truth; live `FAMILY_ROUTE` flip |
