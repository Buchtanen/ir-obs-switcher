...
| v2 narrative runtime (tato větev) | [v2.0.0](../v2.0.0/README.md), [implementation-handover](../v2.0.0/implementation-handover.md), [inflight § #271 eval corpus](inflight/README.md#271-eval-corpus-lookup) ([lookup table #239–#271](inflight/README.md#implementation-lookup-239271-branch-only)) | master `domeny/commentary.md` jako shipped v2 |
