...
| v2 narrative runtime (tato větev) | [v2.0.0](../v2.0.0/README.md), [implementation-handover](../v2.0.0/implementation-handover.md) | master `domeny/commentary.md` jako shipped v2 |
