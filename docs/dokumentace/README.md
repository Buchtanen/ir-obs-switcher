...
| #278 vertical-slice acceptance (Slice 1–12 + Slice 13 F14/F35 playback/replace) | [vertical-slice-acceptance.md § Slice 13](../v2.0.0/vertical-slice-acceptance.md#slice-13--f14f35-playback-race--planning-replace-runtime-drivers), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), …, [`tests/test_vertical_slice_context_prompt_runtime.py`](../../tests/test_vertical_slice_context_prompt_runtime.py), [`tests/test_vertical_slice_playback_replace_runtime.py`](../../tests/test_vertical_slice_playback_replace_runtime.py) |
