...
| Wave G #277 context family map (slice 7 inventory shadow) | [context-family-migration.md](../v2.0.0/context-family-migration.md), [inflight § #277 slice 7](inflight/README.md#277-context-family-map-slice-7-lookup), [events branch delta](domeny/events.md#context-family-migration-map-contractscontext_family_mappy) | `domeny/events.md` as shipped map truth; live `FAMILY_ROUTE` flip deferred (#279) |
| Wave G #276 ops family map (**CLOSED**); Wave G #277 context family map (slice 7 inventory shadow) (slice 7 shadow open) | [ops-family-migration.md](../v2.0.0/ops-family-migration.md), [inflight § #276 slice 6](inflight/README.md#276-ops-family-map-slice-6-lookup), [events branch delta](domeny/events.md#ops-family-migration-map-contractsops_family_mappy) | `domeny/events.md` as shipped map truth; live `FAMILY_ROUTE` flip |
