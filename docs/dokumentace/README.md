...
| v2 narrative runtime (tato větev) | [v2.0.0](../v2.0.0/README.md), [implementation-handover](../v2.0.0/implementation-handover.md), [inflight § #269 Qwen transport](inflight/README.md#269-qwen-transport-lookup) ([lookup table #239–#269](inflight/README.md#implementation-lookup-239269-branch-only)) | master `domeny/commentary.md` jako shipped v2 |
