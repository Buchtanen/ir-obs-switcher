...
| #278 vertical-slice acceptance (Slice 1 offline fixture harness) | [vertical-slice-acceptance.md](../v2.0.0/vertical-slice-acceptance.md), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), [inflight § #278 slice 1](inflight/README.md#278-vertical-slice-fixtures-slice-1-lookup), [testy-ci § #278](domeny/testy-ci.md#278-vertical-slice-fixture-pytest-harness-slice-1) | live Windows §24.9 GO; `machine/*` hash rewrite; `CONFIG.md` / `API.md` unchanged |
