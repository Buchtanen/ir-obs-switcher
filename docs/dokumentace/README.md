...
| #278 vertical-slice acceptance (Slice 1–11 + Slice 12 F18/F33 context/prompt) | [vertical-slice-acceptance.md § Slice 12](../v2.0.0/vertical-slice-acceptance.md#slice-12--f18f33-context-cut--prompt-freedom-runtime-drivers), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), …, [`tests/test_vertical_slice_facts_freshness_runtime.py`](../../tests/test_vertical_slice_facts_freshness_runtime.py), [`tests/test_vertical_slice_context_prompt_runtime.py`](../../tests/test_vertical_slice_context_prompt_runtime.py) |
