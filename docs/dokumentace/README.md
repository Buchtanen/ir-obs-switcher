...
| Wave G #274 race-outcome family map (slice 5, open PR) | [race-outcome-migration.md](../v2.0.0/race-outcome-migration.md), [inflight § #274](inflight/README.md#274-race-outcome-family-map-slice-3-lookup), [events branch delta](domeny/events.md#race-outcome-migration-map-contractsrace_outcome_family_mappy) | `domeny/events.md` as shipped map truth; `mapa-souboru.md` (absent on branch) |
