...
| v2 narrative runtime (tato větev) | [v2.0.0](../v2.0.0/README.md), [implementation-handover](../v2.0.0/implementation-handover.md), [inflight § #270 SemanticVerifier](inflight/README.md#270-semantic-verifier-lookup) ([lookup table #239–#270](inflight/README.md#implementation-lookup-239270-branch-only)) | master `domeny/commentary.md` jako shipped v2 |
