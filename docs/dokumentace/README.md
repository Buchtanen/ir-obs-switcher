...
| #278 vertical-slice acceptance (Slice 1 harness + Slice 2 expiry + Slice 3 F02/F03/F04 transition runtime) | [vertical-slice-acceptance.md § Slice 3](../v2.0.0/vertical-slice-acceptance.md#slice-3--f02f03f04-transition-runtime-drivers), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), [`tests/test_vertical_slice_expiry_runtime.py`](../../tests/test_vertical_slice_expiry_runtime.py), [`tests/test_vertical_slice_transition_runtime.py`](../../tests/test_vertical_slice_transition_runtime.py), [inflight § #278 slice 1](inflight/README.md#278-vertical-slice-fixtures-slice-1-lookup), [inflight § #278 slice 2](inflight/README.md#278-vertical-slice-expiry-runtime-slice-2-lookup), [inflight § #278 slice 3](inflight/README.md#278-vertical-slice-transition-runtime-slice-3-lookup), [testy-ci § #278 slice 1](domeny/testy-ci.md#278-vertical-slice-fixture-pytest-harness-slice-1), [testy-ci § #278 slice 2](domeny/testy-ci.md#278-vertical-slice-expiry-runtime-slice-2), [testy-ci § #278 slice 3](domeny/testy-ci.md#278-vertical-slice-transition-runtime-slice-3) | live Windows §24.9 GO; `machine/*` hash rewrite; **`CONFIG.md` / `API.md` unchanged** |
