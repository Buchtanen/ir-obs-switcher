...
| #278 vertical-slice acceptance (Slice 1–13 + Slice 14 F28 feature-order) | [vertical-slice-acceptance.md § Slice 14](../v2.0.0/vertical-slice-acceptance.md#slice-14--f28-feature-order--bucket-coverage-runtime-drivers), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), …, [`tests/test_vertical_slice_playback_replace_runtime.py`](../../tests/test_vertical_slice_playback_replace_runtime.py), [`tests/test_vertical_slice_feature_order_runtime.py`](../../tests/test_vertical_slice_feature_order_runtime.py) |
