...
| Wave G #277 context family map (**CLOSED** — slice 7 inventory shadow) | [context-family-migration.md](../v2.0.0/context-family-migration.md), [inflight § #277 slice 7](inflight/README.md#277-context-family-map-slice-7-lookup), [events branch delta](domeny/events.md#context-family-migration-map-contractscontext_family_mappy) | `domeny/events.md` as shipped map truth; live `FAMILY_ROUTE` flip deferred (#279) |
| Wave G #276 ops family map (**CLOSED**) | [ops-family-migration.md](../v2.0.0/ops-family-migration.md), [inflight § #276 slice 6](inflight/README.md#276-ops-family-map-slice-6-lookup), [events branch delta](domeny/events.md#ops-family-migration-map-contractsops_family_mappy) | `domeny/events.md` as shipped map truth; live `FAMILY_ROUTE` flip |
| #278 vertical-slice acceptance (Slice 1–7 + Slice 8 F09/F11 Qwen hard-fail) | [vertical-slice-acceptance.md § Slice 8](../v2.0.0/vertical-slice-acceptance.md#slice-8--f09f11-qwen-hard-fail-runtime-drivers), [`tests/test_vertical_slice_fixtures.py`](../../tests/test_vertical_slice_fixtures.py), [`tests/test_vertical_slice_expiry_runtime.py`](../../tests/test_vertical_slice_expiry_runtime.py), [`tests/test_vertical_slice_transition_runtime.py`](../../tests/test_vertical_slice_transition_runtime.py), [`tests/test_vertical_slice_scoring_runtime.py`](../../tests/test_vertical_slice_scoring_runtime.py), [`tests/test_vertical_slice_silence_runtime.py`](../../tests/test_vertical_slice_silence_runtime.py), [`tests/test_vertical_slice_policy_runtime.py`](../../tests/test_vertical_slice_policy_runtime.py), [`tests/test_vertical_slice_partition_silence_runtime.py`](../../tests/test_vertical_slice_partition_silence_runtime.py), [`tests/test_vertical_slice_qwen_runtime.py`](../../tests/test_vertical_slice_qwen_runtime.py), [inflight § #278 slice 1](inflight/README.md#278-vertical-slice-fixtures-slice-1-lookup), [inflight § #278 slice 2](inflight/README.md#278-vertical-slice-expiry-runtime-slice-2-lookup), [inflight § #278 slice 3](inflight/README.md#278-vertical-slice-transition-runtime-slice-3-lookup), [inflight § #278 slice 4](inflight/README.md#278-vertical-slice-scoring-runtime-slice-4-lookup), [inflight § #278 slice 5](inflight/README.md#278-vertical-slice-silence-runtime-slice-5-lookup), [inflight § #278 slice 6](inflight/README.md#278-vertical-slice-policy-runtime-slice-6-lookup), [inflight § #278 slice 7](inflight/README.md#278-vertical-slice-partition-silence-runtime-slice-7-lookup), [inflight § #278 slice 8](inflight/README.md#278-vertical-slice-qwen-runtime-slice-8-lookup), [testy-ci § #278 slice 1](domeny/testy-ci.md#278-vertical-slice-fixture-pytest-harness-slice-1), [testy-ci § #278 slice 2](domeny/testy-ci.md#278-vertical-slice-expiry-runtime-slice-2), [testy-ci § #278 slice 3](domeny/testy-ci.md#278-vertical-slice-transition-runtime-slice-3), [testy-ci § #278 slice 4](domeny/testy-ci.md#278-vertical-slice-scoring-runtime-slice-4), [testy-ci § #278 slice 5](domeny/testy-ci.md#278-vertical-slice-silence-runtime-slice-5), [testy-ci § #278 slice 6](domeny/testy-ci.md#278-vertical-slice-policy-runtime-slice-6), [testy-ci § #278 slice 7](domeny/testy-ci.md#278-vertical-slice-partition-silence-runtime-slice-7), [testy-ci § #278 slice 8](domeny/testy-ci.md#278-vertical-slice-qwen-runtime-slice-8) | live Windows §24.9 GO; `machine/*` hash rewrite; **`CONFIG.md` / `API.md` unchanged** |
