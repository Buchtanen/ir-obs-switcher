# Events — branch delta (#272 **CLOSED**; #273 **CLOSED**; #274 closeout evidence; #275 slice 3 open; #284 **CLOSED** merged @ `77452a9`)
...
| Helper | Role |
| --- | --- |
| `timing_family_rows()` | Closed rows for lap/SF, sector, PB/pace, `HOT_LAP` / `PROJECTED_LAP` / `INVALID_LAP` |
