...
**#284 CLOSED** (**41/41** AC — process TDD AC via human-accepted TDD-exception; human close gate satisfied). Stack PR [#289](https://github.com/Buchtanen/ir-obs-switcher/pull/289) → base `codex/commentary-story-flow-spec`; **no master merge**. Next work: v2 integration remainder (#273 master cutover, race tape wire, deeper tape-run wiring — not #284 open work).
