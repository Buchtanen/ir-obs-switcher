...
- **Docs impact:** branch-only `inflight/` + `docs/v2.0.0/` (`README`, `catalog-behavior`, `event-beat-disposition`, `implementation-handover`, `jak-cist`); no public CONFIG/API/README change; `machine/` hashes unchanged. First SHA `89f89be`; docs checkpoint `e2f2eda`; feat CI [34351003627](https://github.com/Buchtanen/ir-obs-switcher/actions/runs/34351003627) pending.
