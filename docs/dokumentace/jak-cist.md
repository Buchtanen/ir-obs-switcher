...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`; modul lookup pro #248 v [inflight § gap estimators](inflight/README.md#248-gap-estimators-lookup). **Žádný PR do `master`** do cutoveru. #248 gap estimators jsou closed (first SHA `4aa2e68`). #249 nespouštět, dokud člověk neřekne. NarrativeRuntime neaktivovat.
