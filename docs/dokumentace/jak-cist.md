...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`. **Žádný PR do `master`** do cutoveru. Další implementační balík je #246 (**neclaimnutý**; nezačínej, dokud neprojdou docs-keeper close-gates pro #239–#244).
