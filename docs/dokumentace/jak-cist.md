...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`; modul lookup pro #258 v [inflight § EpisodeRegistry](inflight/README.md#258-lineage-aware-episoderegistry-lookup) (#257: [catalog loader](inflight/README.md#257-storydefinition-catalog-loader-lookup); #256: [coverage matrix](inflight/README.md#256-event-family-coverage-matrix-lookup)). **Žádný PR do `master`** do cutoveru. #258 EpisodeRegistry je implemented (first SHA `dc4ef40`). #259 nespouštět, dokud člověk neřekne. NarrativeRuntime neaktivovat.
