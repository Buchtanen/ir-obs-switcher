...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`; modul lookup pro #249 v [inflight § predicate AST](inflight/README.md#249-predicate-ast-lookup). **Žádný PR do `master`** do cutoveru. #249 first SHA `b24e3da`. #250 nespouštět, dokud člověk neřekne. NarrativeRuntime neaktivovat.
