...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`. **Žádný PR do `master`** do cutoveru. #246 je closed; další balík je #247 (neclaimnutý). NarrativeRuntime neaktivovat.
