...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`; modul lookup pro #251 v [inflight § direct edges](inflight/README.md#251-direct-lapsector-edges-lookup). **Žádný PR do `master`** do cutoveru. #251 DirectEdgeBank je closed (first SHA `5a61be3`). #252/#253 nespouštět, dokud člověk neřekne. NarrativeRuntime neaktivovat.
