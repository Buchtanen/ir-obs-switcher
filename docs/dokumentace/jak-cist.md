...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`. **Žádný PR do `master`** do cutoveru. #246 inheritance slice `abe4d1a` je na této větvi; NarrativeRuntime neaktivovat.
