...
9. Na v2 větvi: handover do `docs/v2.0.0/implementation-handover.md`. **Žádný PR do `master`** do cutoveru. Další implementační balík je #246, dokud ho někdo neclaimne.
